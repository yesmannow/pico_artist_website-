...
const menuItems = [
  ...
  },
  {
    ...
    blurb: 'Shows, performances & tickets',
  },
  {
    title: 'Visualizer',
    href: '/visualizer',
    ...
    blurb: 'Interactive audio visualizer',
  },
];
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <button
              onClick={toggleMenu}
              className="relative min-h-[44px] min-w-[44px] h-11 w-11 rounded-full bg-gradient-to-r from-piko-teal to-piko-pink p-2 shadow-lg shadow-piko-pink/20 transition-all hover:scale-110 hover:shadow-piko-pink/40 active:scale-95"
